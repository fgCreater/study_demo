...
void callback(const sensor_msgs::PointCloud2::ConstPtr &points_01,const sensor_msgs::PointCloud2::ConstPtr &points_02,const sensor_msgs::PointCloud2::ConstPtr &points_03){
    ROS_INFO("时间同步u");
}
int main(int argc, char *argv[])
{
    ...
    message_filters::Subscriber<sensor_msgs::PointCloud2>points_03(nh,"filted_points_03",10);
    ...
    message_filters:: Synchronizer<MySyncPolicy>sync (MySyncPolicy(10),points_01,points_02,points_03);
